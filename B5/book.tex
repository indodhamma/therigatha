...
\end{quote}
\begin{flushleft}
Buku ini merupakan terjemahan dari Therıgatha karya Indra Anggara
tahun 2020.
\par\end{flushleft}

Edisi ini diketik dan diulas oleh anggota Vihara Santi Graha, Tanjung
Redeb, Berau pada bulan Maret 2022 tepat saat Hari Peringatan Perempuan
Internasional.

Buku ini tidak akan mungkin terwujud tanpa karya Bhante Sujato dan
proyeknya \underline{https://suttacentral.net/} . Kami berterima
kasih kepada Bhante Sujato atas usahanya. projek beliau sangat membantu
dan memudahkan kita untuk dapat mengakses Dhamma dan berterimakasih
pada beliau dalam memerangi patriarki.

Edisi ini, serupa dengan terjemahan Indra Anggara dan karya-karya
terkait SuttaCentral Bhante Sujato yang dirilis ke domain publik,
tanpa hak cipta, dan dapat diedit, disalin, dicetak, dan dibagikan
secara bebas tanpa izin atau batasan.

File komputer tersedia online: 

\underline{https://github.com/indodhamma/therigatha}
\end{document}
